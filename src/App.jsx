...
import { fetchAllCalculations } from "./services/operatonService";
...
const PropertyDashboard = () => {
  ...
  const contractors = [
    {
      id: 1,
      name: "IsolatieGroep Rotterdam",
      specialty: "Dakisolatie specialist",
      rating: 4.8,
    },
    {
      id: 2,
      name: "EcoTherm Isolatie",
      specialty: "Duurzame isolatie",
      rating: 4.7,
    },
    {
      id: 3,
      name: "DakTotaal B.V.",
      specialty: "Complete dakoplossingen",
      rating: 4.9,
    },
    ...
    {
      id: 6,
      name: "GreenRoof Solutions",
      specialty: "Groene daken & isolatie",
      rating: 4.8,
    },
  ];
  ...
  const handleRequestAdvice = async () => {
    if (dataConsentGiven && selectedContractor) {
      ...
      try {
        const baseParams = {
          huidige_r_waarde: buildingData.bestaande_isolatie.R_waarde_m2K_per_W,
          dak_oppervlakte_m2: buildingData.gebouw.vloeroppervlakte_m2,
          lambda_w_mk: 0.035,
          materiaal_cost_per_m3: 80,
          install_cost_per_m2_per_100mm: 25,
        };

        const result = await fetchAllCalculations(baseParams);
                ...
                <div className="space-y-4">
                  ...
                  <div className="mt-6 pt-6 border-t border-gray-200">
                    <h4 className="text-base font-semibold text-gray-900 mb-4">
                      Uw verbruik vergeleken met andere huishoudens en
                      woningtypes
                    </h4>
                  ...
                  {personalizedInfo.recommendedImprovements.map(
                    (improvement, index) => (
                      <div
                        ...
                        onClick={() =>
                          index === 0 && handleRoofInsulationClick()
                        }
                      >
                    ...
                    <dl className="space-y-1 text-sm">
                      <div className="flex justify-between">
                        ...
                        <dd className="font-medium">
                          {buildingData.gebouw.gebouwtype}
                        </dd>
                      </div>
                      <div className="flex justify-between">
                        <dt className="text-gray-600">Bouwjaar:</dt>
                        <dd className="font-medium">
                          {buildingData.gebouw.bouwjaar}
                        </dd>
                      </div>
                      <div className="flex justify-between">
                        <dt className="text-gray-600">Vloeroppervlakte:</dt>
                        <dd className="font-medium">
                          {buildingData.gebouw.vloeroppervlakte_m2} m²
                        </dd>
                      </div>
                      <div className="flex justify-between">
                        <dt className="text-gray-600">Bezetting:</dt>
                        <dd className="font-medium">
                          {buildingData.gebouw.bezettingspatroon.replace(
                            /_/g,
                            " ",
                          )}
                        </dd>
                  ...
                  <div>
                    ...
                    <dl className="space-y-1 text-sm">
                      <div className="flex justify-between">
                        <dt className="text-gray-600">Type:</dt>
                        <dd className="font-medium">
                          {buildingData.dak.daktype}
                        </dd>
                      </div>
                      <div className="flex justify-between">
                        <dt className="text-gray-600">Helling:</dt>
                        <dd className="font-medium">
                          {buildingData.dak.dakhelling_graden}°
                        </dd>
                      </div>
                      <div className="flex justify-between">
                        <dt className="text-gray-600">Bedekking:</dt>
                        <dd className="font-medium">
                          {buildingData.dak.dakbedekking_materiaal.replace(
                            /_/g,
                            " ",
                          )}
                        </dd>
                  ...
                  <div>
                    ...
                    <dl className="space-y-1 text-sm">
                      <div className="flex justify-between">
                        <dt className="text-gray-600">Type:</dt>
                        <dd className="font-medium">
                          {buildingData.bestaande_isolatie.type}
                        </dd>
                      </div>
                      <div className="flex justify-between">
                        <dt className="text-gray-600">Dikte:</dt>
                        <dd className="font-medium">
                          {buildingData.bestaande_isolatie.dikte_mm} mm
                        </dd>
                      </div>
                      <div className="flex justify-between">
                        <dt className="text-gray-600">R-waarde:</dt>
                        <dd className="font-medium">
                          {buildingData.bestaande_isolatie.R_waarde_m2K_per_W}{" "}
                          m²·K/W
                        </dd>
                      </div>
                      <div className="flex justify-between">
                        ...
                        <dd className="font-medium">
                          {buildingData.bestaande_isolatie.dampscherm_aanwezig
                            ? "Ja"
                            : "Nee"}
                        </dd>
                      </div>
                  ...
                  <div>
                    ...
                    <dl className="space-y-1 text-sm">
                      <div className="flex justify-between">
                        ...
                        <dd className="font-medium">
                          {buildingData.klimaat.klimaatzone}
                        </dd>
                      </div>
                      <div className="flex justify-between">
                        <dt className="text-gray-600">Ventilatie:</dt>
                        <dd className="font-medium">
                          {buildingData.vocht_en_ventilatie.zolderventilatie_type.replace(
                            /_/g,
                            " ",
                          )}
                        </dd>
                      ...
                      <div className="flex justify-between">
                        ...
                        <dd className="font-medium">
                          {buildingData.vocht_en_ventilatie.vochtproblemen.replace(
                            /_/g,
                            " ",
                          )}
                        </dd>
              ...
              <div className="border border-gray-200 rounded-lg p-6">
                <div className="flex items-start gap-3">
                  ...
                  <label htmlFor="dataConsent" className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">
                      Ik geef toestemming om mijn gebouwgegevens te delen met de
                      geselecteerde aannemer voor het maken van een offerte voor
                      dakisolatie. Deze gegevens worden alleen gebruikt voor dit
                      doel en niet gedeeld met derden.
                    </p>
                  </label>
                </div>
              </div>
              ...
              {showCalculations && (
                <div className="border border-blue-200 bg-blue-50 rounded-lg p-6">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900">
                      Voorbeeldberekening dakisolatie
                    </h3>
                  </div>
                  ...
                  {calculationError && (
                    <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-4">
                      <p className="text-red-800 font-semibold">
                        Fout bij berekeningen
                      </p>
                      <p className="text-red-600 text-sm">{calculationError}</p>
                      <p className="text-red-600 text-sm mt-2">
                        Controleer of Operaton draait op http://localhost:8080
                      </p>
                    </div>
                  )}

                  {/* Existing calculations display - only show if data loaded */}
                  {!isLoadingCalculations && calculations && (
                    <>
                      <p className="text-sm text-gray-600 mb-4">
                        Op basis van uw gebouwgegevens hebben we verschillende
                        isolatie-opties berekend:
                      </p>
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm">
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium">
                              {calculations.aanname.R_bestaand} m²·K/W
                            </span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600">
                            ...
                            <span className="font-medium">
                              {calculations.aanname.dak_oppervlakte_m2} m²
                            </span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600">
                              Huidige verwarmingskosten:
                            </span>
                            <span className="font-medium">
                              €{" "}
                              {
                                calculations.aanname
                                  .huidige_jaarlijkse_verwarmingskosten_eur
                              }
                              /jaar
                            </span>
                          </div>
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium">
                              €{" "}
                              {
                                buildingData.energie_en_budget
                                  .energiekosten_per_kWh
                              }
                              /kWh
                            </span>
                          </div>
                        ...
                        <table className="w-full text-sm">
                          ...
                          <tbody className="bg-white">
                            {calculations.berekeningen.map((calc, idx) => (
                              <tr
                                key={idx}
                                className={`border-t border-gray-200 ${calc.doel_R === 6.0 ? "bg-green-50 font-semibold" : ""}`}
                              >
                                <td className="px-3 py-2">
                                  {calc.doel_R.toFixed(1)}
                                </td>
                                <td className="px-3 py-2">
                                  {calc.delta_R.toFixed(1)}
                                </td>
                                <td className="px-3 py-2">
                                  {calc.extra_dikte_mm.toFixed(0)}
                                </td>
                                <td className="px-3 py-2">
                                  € {calc.kost_per_m2_eur.toFixed(2)}
                                </td>
                                <td className="px-3 py-2">
                                  € {calc.totale_kost_eur.toFixed(0)}
                                </td>
                                <td className="px-3 py-2 text-green-600">
                                  € {calc.subsidie_eur.toFixed(0)}
                                </td>
                                <td className="px-3 py-2 font-semibold">
                                  € {calc.netto_kost_eur.toFixed(0)}
                                </td>
                                <td className="px-3 py-2 text-green-600">
                                  € {calc.jaarlijkse_besparing_eur.toFixed(0)}
                                </td>
                                <td className="px-3 py-2">
                                  {calc.terugverdientijd_jaar.toFixed(1)}
                                </td>
                              </tr>
                            ))}
                          </tbody>
                      ...
                      <div className="mt-4 bg-green-100 border border-green-300 rounded-lg p-4">
                        <p className="text-sm text-gray-700">
                          {calculations.berekeningen[2].aanbeveling ||
                            `Aanbevolen: R-waarde 6.0 m²·K/W (gemarkeerd in groen) biedt de beste balans 
               tussen investering, subsidie en terugverdientijd van ${calculations.berekeningen[2].terugverdientijd_jaar.toFixed(1)} jaar.`}
                        </p>
                      </div>
